...
Last activity: 2026-06-30 — Roadmap rebuilt after Round 3 critique for 84 v1 requirements (CI/deploy substrate + sourcing spike + open-data licence + corpus rubric land in Phase 1; reader-facing staleness indicator in Phase 2; descriptive ingredient pages; credibility surface — disclaimer, About/independence, citation+export, RSS, report-an-error — in Phase 3b; SPIKE-01-derived corpus sizing; legal/a11y gates now early-and-terminal)
