...
**Core Value:** Every fact is traceable to a primary source with an explicit confidence level — transparency over persuasion. If everything else fails, a user must be able to trust that what the database says about a product or ingredient is sourced, dated, and honest about its uncertainty.
